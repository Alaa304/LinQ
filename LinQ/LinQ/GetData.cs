...
namespace LinQ
{
    public static class GetData
    {
        ...
        public static List<CustomerCategory> GetCategories()
        {
            ...
            categories.Add(new CustomerCategory() { Id = 4, Name = "Block" });
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            customers.Add(new Customer { id = 111, name = "No one", age = 37, isActive = true, joinDate = new DateTime(2023, 7, 12), categoryId = 4, spendAverage = 9632.2m, telephone = 123333339 });
            return customers;
        }
